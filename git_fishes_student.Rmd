...
# Write your answer here
#If we change echo = TRUE to echo = FALSE, it means that we want to have both code and result in our rmarkdown file.
```
...
When we permutate our data, we find that there is no significant difference between original t-test and permutated t-test in p-value. So we can safely arrive at a conclusion that there is no significant difference between treantment in lemon.
