...
Everytime I need to modify my code, I need to save it on my own computer, save it in GitHub Desktop and upload it into the GitHub. So it can not be automatically change on the GitHub website and record each steps of mordification.
```
...
# Write your answer here
If we change echo = TRUE to echo = FALSE, it means that we want to have the answer with this block. Acturally we just write some explaintion of answers instead of some code that can run for some purpose.
```
