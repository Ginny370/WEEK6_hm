...
```{r, echo=TRUE, eval = FALSE}
## Write your answer here
#I find that the `.gitignore` text file, which contains the path of the boxplot picture, is added into my *GitHub Desktop* and the figure disappear in my output/figure folder. 
```
